...
public class ComponentRegistry {
    ...
    static {
        ...
        register(new CriticalCondition());
        register(new CrouchCondition());
        register(new DodgeCondition());
        ...
        register(new ClearThreatMechanic());
        register(new ShuffleThreatMechanic());
        ...
        // Legacy editor outlines are distinct mechanics, not filled particle arrangements.
        register(new ParticleRingMechanic());
        register(new ParticlePolygonMechanic());
        register(new ParticlePointLineMechanic());
        register(new ParticleAnimationArmorStandMechanic());
        register(new ParticleAnimationMechanic());
        register(new ParticleChainMechanic());
        register(new ParticleEffectMechanic());
        register(new ParticleLineMechanic());
        register(new ParticleProjectileMechanic());
        register(new ParticleSineWaveMechanic());
        register(new ParticleSphereMechanic());
        ...
        register(new ValueMobAttributeMechanic());
